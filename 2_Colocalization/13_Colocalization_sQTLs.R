...
wb<-fread("Splicing_GTEx/Whole_Blood.v8.sqtl_allpairs_filtered.txt")
...
snps<-fread("GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze.lookup_table.txt")
...
fwrite(results,"Coloc_results_abf_splice.csv")
