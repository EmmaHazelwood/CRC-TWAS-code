...
snps<-fread("/projects/MRC_IEU/research/projects/icep2/wp2/034/working/data/GTEx-Colon/GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze.lookup_table.txt")
...
for (a in unique(list$id)){
  ...
  b<-mr$subtype[1]
    ...
    outcome_dat <- read_outcome_data(
      ...
      filename = paste("/projects/MRC_IEU/research/projects/icep2/wp2/005/working/data/gecco/annotated/",b,"_CRC_GWAS_noUKBio_summary_stats_annotated.txt",sep=""),
      sep = " ",
      snp_col = "SNP",
      beta_col = "Effect",
      se_col = "StdErr",
