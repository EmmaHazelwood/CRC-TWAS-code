...
mr_res<-fread("data/CRC_TWAS/MR_results_Strong.csv")
...
mr_res_sig<-fread("data/CRC_TWAS/MR_results_Strong.csv")
...
fwrite(res_sig,"data/CRC_TWAS/Coloc_results_abf_splice_strong.csv")
